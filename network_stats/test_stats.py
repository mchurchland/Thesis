...
class GeneralizationRankTests(unittest.TestCase):
    ...
    def test_kr_streams_are_independent_length_ten_sequences(self) -> None:
    ...
    def test_run_one_resets_rank_streams_and_avoids_sample_capped_ranks(self) -> None:
        with mock.patch(
        ...
        self.assertEqual(kr_streams.shape[0], 4)
